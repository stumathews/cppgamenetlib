...
namespace gamenetlib
{
	...
	std::shared_ptr<gamelib::PlayerMovedEvent> BitPackedEventSerializationManager::DeserializePlayerMovedEvent(
		std::string serializedMessage)
	{
		return json.DeserializePlayerMovedEvent(serializedMessage);
	}

	std::string BitPackedEventSerializationManager::SerializePlayerMovedEvent(std::shared_ptr<gamelib::PlayerMovedEvent> object,
		std::string target)
	{
	...
	std::string BitPackedEventSerializationManager::CreateUnknownEventMessage(std::shared_ptr<gamelib::Event> evt,
		std::string target)
	{
