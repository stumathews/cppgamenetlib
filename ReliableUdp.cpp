...
gamenetlib::Message* gamenetlib::ReliableUdp::MarkSent(PacketDatum datum, const MessageType messageType)
{
...
void gamenetlib::ReliableUdp::MarkReceived(const Message& senderMessage, const unsigned long receivedTimeMs)
{
...
uint32_t gamenetlib::ReliableUdp::GenerateAcknowledgedBits()
{
