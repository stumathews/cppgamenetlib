...
namespace gamenetlib
{
	...
	std::shared_ptr<gamelib::PlayerMovedEvent> XmlEventSerializationManager::DeserializePlayerMovedEvent(
		std::string serializedMessage)
	{
		return json.DeserializePlayerMovedEvent(serializedMessage);
	}

	std::string XmlEventSerializationManager::SerializePlayerMovedEvent(std::shared_ptr<gamelib::PlayerMovedEvent> object,
		std::string target)
	{
	...
	std::string XmlEventSerializationManager::SerializeControllerMoveEvent(
		std::shared_ptr<gamelib::ControllerMoveEvent> object, std::string target)
	{
		return json.SerializeControllerMoveEvent(object, target);
	}

	std::string XmlEventSerializationManager::CreateUnknownEventMessage(std::shared_ptr<gamelib::Event> evt,
		std::string target)
	{
	...
	std::shared_ptr<gamenetlib::StartNetworkLevelEvent> XmlEventSerializationManager::DeserializeStartNetworkLevel(
		std::string serializedMessage)
	{
