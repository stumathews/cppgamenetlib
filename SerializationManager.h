...
namespace gamenetlib
{
	...
	class SerializationManager
	{
		...
		std::shared_ptr<gamenetlib::IEventSerializationManager> eventSerialization;
		[[nodiscard]] std::string CreatePlayerMovedEventMessage(const std::shared_ptr<gamelib::Event>& event, const std::string& target) const;
		[[nodiscard]] std::string CreateControllerMoveEventMessage(const std::shared_ptr<gamelib::Event>& evt, const std::string& target) const;
		[[nodiscard]] std::string CreateStartNetworkLevelMessage(const std::shared_ptr<gamelib::Event>& evt, const std::string& target) const;
	...
	public:
		...
		[[nodiscard]] std::shared_ptr<gamelib::Event> Deserialize(const MessageHeader& messageHeader, const std::string& serializedMessage) const;
		[[nodiscard]] std::string SerializeEvent(const std::shared_ptr<gamelib::Event>& evt, const std::string& target) const;
		[[nodiscard]] std::string CreateUnknownEventMessage(const std::shared_ptr<gamelib::Event>& evt, const std::string& target) const;
