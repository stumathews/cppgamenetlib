...
gamenetlib::Message::Message(const uint16_t sequence, const uint16_t lastAckedSequence, uint32_t previousAckedBits,
...
// internal
void gamenetlib::Message::Write(BitPacker<uint32_t>& bitPacker, const bool includeCheckSum) const
{
	// Pack the header
...
// internal
void gamenetlib::Message::Read(BitfieldReader<uint32_t>& bitfieldReader, const bool includeCheckSum)
{
...
// public
void gamenetlib::Message::Write(BitPacker<uint32_t>& bitPacker) const
{
...
// public
void gamenetlib::Message::Read(BitfieldReader<uint32_t>& bitfieldReader)
{
	// Read the message from the provided bitfieldReader
	Read(bitfieldReader, true);
}

uint32_t gamenetlib::Message::GenerateCheckSum()
{
...
bool gamenetlib::Message::ValidateChecksum(const uint32_t yourChecksum)
{
	const auto myChecksum = GenerateCheckSum();
	return myChecksum == yourChecksum;
}

bool gamenetlib::Message::ValidateChecksum()
{
	return ValidateChecksum(this->Header.CheckSum);
}

std::vector<gamenetlib::PacketDatum> gamenetlib::Message::Data() const
{
	return packets;
}

uint16_t gamenetlib::Message::DataCount() const
{
	return packets.size();
}
